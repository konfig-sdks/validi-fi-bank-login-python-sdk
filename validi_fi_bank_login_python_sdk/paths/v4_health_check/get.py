...
class CheckHealthRaw(BaseApi):
    ...
    async def acheck_health(
        ...
        **kwargs,
        ...
        args = self._check_health_mapped_args(
            body=body,
        )
        return await self._acheck_health_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def check_health(
        ...
        return self._check_health_oapg(
            body=args.body,
        )

class CheckHealth(BaseApi):
    ...
    async def acheck_health(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_health(
            body=body,
            **kwargs,
        )
    ...
    def check_health(
        ...
        raw_response = self.raw.check_health(
            body=body,
        )
