...
# Path params
InquiryIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'inquiryId': typing.Union[InquiryIdSchema, str, ],
    }
)
...
request_path_inquiry_id = api_client.PathParameter(
    name="inquiryId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=InquiryIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyTextPlain = schemas.AnyTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_insight_by_id_mapped_args(
        self,
        inquiry_id: str,
        ...
        if inquiry_id is not None:
            _path_params["inquiryId"] = inquiry_id
        args.path = _path_params
        return args

    async def _aget_insight_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v4/Insights/2/{inquiryId}',
            body=body,
            headers=_headers,
        )
...
class GetInsightByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_insight_by_id(
        self,
        inquiry_id: str,
        body: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        **kwargs,
        ...
        args = self._get_insight_by_id_mapped_args(
            body=body,
            inquiry_id=inquiry_id,
        )
        return await self._aget_insight_by_id_oapg(
            body=args.body,
    ...
    def get_insight_by_id(
        ...
        return self._get_insight_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class GetInsightById(BaseApi):
    ...
    async def aget_insight_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_insight_by_id(
            body=body,
            inquiry_id=inquiry_id,
            **kwargs,
        )
    ...
    def get_insight_by_id(
        ...
        raw_response = self.raw.get_insight_by_id(
            body=body,
            inquiry_id=inquiry_id,
        )
