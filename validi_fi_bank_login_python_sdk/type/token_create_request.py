...
class RequiredTokenCreateRequest(TypedDict):
    pass

class OptionalTokenCreateRequest(TypedDict, total=False):
    clientId: str

    clientSecret: str

class TokenCreateRequest(RequiredTokenCreateRequest, OptionalTokenCreateRequest):
    pass
