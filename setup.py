...
NAME = "validi-fi-bank-login-python-sdk"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="RIBBIT API v4",
    author="Konfig",
    author_email="engineering@konfigthis.com",
    url="https://github.com/konfig-sdks/validi-fi-bank-login-python-sdk/tree/main/python",
    keywords=["Konfig", "RIBBIT API v4"],
    python_requires=">=3.7",
